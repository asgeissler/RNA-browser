...
LABEL io.github.snakemake.conda_env_hash="4fafe741820d19041e141b9ae0793f3a96b1ac746c05833444014dab2677df62"
...
ADD https://github.com/snakemake/snakemake-wrappers/raw/v3.3.1/bio/bedtools/genomecov/environment.yaml /conda-envs/4bc1c7d4971260f38b3717e4c2f2ddf4/environment.yaml
...
RUN mkdir -p /conda-envs/268b7472c1a4796c93dadab56996fe66
ADD https://github.com/snakemake/snakemake-wrappers/raw/v3.3.1/bio/bowtie2/align/environment.yaml /conda-envs/268b7472c1a4796c93dadab56996fe66/environment.yaml
...
#   dependencies:
#     - bowtie2 =2.5.2
RUN mkdir -p /conda-envs/27745e708d957131953ee2d8014548b8
ADD https://github.com/snakemake/snakemake-wrappers/raw/v3.3.1/bio/bowtie2/build/environment.yaml /conda-envs/27745e708d957131953ee2d8014548b8/environment.yaml
...
ADD https://github.com/snakemake/snakemake-wrappers/raw/v3.3.1/bio/multiqc/environment.yaml /conda-envs/a74c0ac65c84ed438731c3397703af31/environment.yaml
...
#   dependencies:
#     - sambamba =1.0
RUN mkdir -p /conda-envs/77ab24369bc402f38c70bd3f6d76d935
ADD https://github.com/snakemake/snakemake-wrappers/raw/v3.3.1/bio/sambamba/index/environment.yaml /conda-envs/77ab24369bc402f38c70bd3f6d76d935/environment.yaml
...
#     - samtools =1.19
#     - snakemake-wrapper-utils =0.6.2
RUN mkdir -p /conda-envs/19158752836267c8da44d21cd05cc69d
ADD https://github.com/snakemake/snakemake-wrappers/raw/v3.3.1/bio/samtools/faidx/environment.yaml /conda-envs/19158752836267c8da44d21cd05cc69d/environment.yaml
...
#   dependencies:
#     - subread =2.0.6
RUN mkdir -p /conda-envs/d9318d504877b504f6a1bac6535ac060
ADD https://github.com/snakemake/snakemake-wrappers/raw/v3.3.1/bio/subread/featurecounts/environment.yaml /conda-envs/d9318d504877b504f6a1bac6535ac060/environment.yaml
...
RUN mkdir -p /conda-envs/1423c0ac4fa57dfebafd031f95067f48
ADD https://github.com/snakemake/snakemake-wrappers/raw/v3.3.1/bio/ucsc/bedGraphToBigWig/environment.yaml /conda-envs/1423c0ac4fa57dfebafd031f95067f48/environment.yaml
...
#   dependencies:
#     - ucsc-fatotwobit =455
RUN mkdir -p /conda-envs/ebf4a0aa942ecd68a840a3c3d2f014a7
ADD https://github.com/snakemake/snakemake-wrappers/raw/v3.3.1/bio/ucsc/faToTwoBit/environment.yaml /conda-envs/ebf4a0aa942ecd68a840a3c3d2f014a7/environment.yaml
...
#   dependencies:
#     - ucsc-twobitinfo =447
RUN mkdir -p /conda-envs/10e85085d7e0c067dd6c2ae36f4db113
ADD https://github.com/snakemake/snakemake-wrappers/raw/v3.3.1/bio/ucsc/twoBitInfo/environment.yaml /conda-envs/10e85085d7e0c067dd6c2ae36f4db113/environment.yaml
